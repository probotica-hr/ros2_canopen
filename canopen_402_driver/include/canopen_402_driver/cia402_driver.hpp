...
class Cia402DriverBase : public ros2_canopen::CanopenDriver, public ros2_canopen::Cia402DriverInterface
{
public:
  Cia402DriverBase(rclcpp::NodeOptions node_options) : CanopenDriver(node_options) { };
};
 ...
 */
class Cia402Driver : public Cia402DriverBase
{
